...
async function main() {
  ...
  const signer = await ethers.getSigner("0x01e650ABfc761C6A0Fc60f62A4E4b3832bb1178b"); // Signer ataması yapılacak
  ...
  let builder = await Presets.Builder.Kernel.init(signer, BUNDLER_RPC_URL)

  const client = await Client.init(rpcUrl);
  res = await client.sendUserOperation(builder.executeBatch(await ApproveAndSwap(addrs.usdc, "0x427FB36C7eb1Ae5a8664807E973134EE46e0A17F", "50")), {
